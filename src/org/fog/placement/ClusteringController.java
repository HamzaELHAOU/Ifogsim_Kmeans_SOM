...
public class ClusteringController extends SimEntity {
    ...
    double 	sum=0 ; 
        for (FogDevice fogDevice : getFogDevices()) {
        	sum=sum+fogDevice.getEnergyConsumption();
    ...
    */
    private void printTimeDetails() {
        ...
        //}
        System.out.println("=========================================");
        System.out.println("TUPLE CPU EXECUTION DELY");
        System.out.println("=========================================");

        for (String tupleType : TimeKeeper.getInstance().getTupleTypeToAverageCpuTime().keySet()) {
            System.out.println(tupleType + " ---> " + TimeKeeper.getInstance().getTupleTypeToAverageCpuTime().
                    get(tupleType));
        }
