...
public class Config {
	...
	//Plage de communication des nœuds
	public static double Node_Communication_RANGE = 1500.0; // In terms of meter 
	//latence de noveau groupe :  la latence est le temps que prend un paquet de données pour voyager d'un point à un autre
