...
public class CleanFromJson {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			PhysicalTopology physicalTopology = JsonToTopology.getPhysicalTopology(broker.getId(), appId, "topologies/routerTopology2");
			...
			List<FogDevice> List=controller.getFogDevices();
			...
			//RandomMobilityGenerator test=new RandomMobilityGenerator();
		//	test.createRandomData(5, 1, appId, true);
			//test.MobilityPositionInitiator(5, 100, 1);
	...
	private static Application createApplication(String appId, int userId){
		...
		application.addTupleMapping("client", "TEMP", "_SENSOR",
