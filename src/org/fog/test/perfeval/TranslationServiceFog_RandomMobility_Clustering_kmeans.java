 ...
 */
public class TranslationServiceFog_RandomMobility_Clustering_kmeans {
    ...
    private static Application createApplication(String appId, int userId) {
       ...
       // application.addAppModule("clientModule1", 10); // adding module Client to the application model
        //application.addAppModule("processingModule1", 10); // adding module Concentration Calculator to the application model
        //application.addAppModule("storageModule1", 10); // adding module Connector to the application model
       ...
       // application.addAppEdge("M-SENSOR", "clientModule1", 3000, 500, "M-SENSOR", Tuple.UP, AppEdge.SENSOR);
      //  application.addAppEdge("clientModule1", "processingModule1", 3500, 500, "RAW_DATA1", Tuple.UP, AppEdge.MODULE); // adding edge from Client to Concentration Calculator module carrying tuples of type _SENSOR
       // application.addAppEdge("processingModule1", "storageModule1", 1000, 1000, "PROCESSED_DATA1", Tuple.UP, AppEdge.MODULE); // adding periodic edge (period=1000ms) from Concentration Calculator to Connector module carrying tuples of type PLAYER_GAME_STATE
      //  application.addAppEdge("processingModule1", "clientModule1", 14, 500, "ACTION_COMMAND1", Tuple.DOWN, AppEdge.MODULE);  // adding edge from Concentration Calculator to Client module carrying tuples of type CONCENTRATION
     //   application.addAppEdge("clientModule1", "M-DISPLAY", 1000, 500, "ACTUATION_SIGNAL1", Tuple.DOWN, AppEdge.ACTUATOR); 
      ...
      //  application.addTupleMapping("clientModule1", "M-SENSOR", "RAW_DATA", new FractionalSelectivity(1.0)); // 0.9 tuples of type _SENSOR are emitted by Client module per incoming tuple of type EEG
       ...
       // application.addTupleMapping("processingModule1", "RAW_DATA", "ACTION_COMMAND", new FractionalSelectivity(1.0)); // 1.0 tuples of type CONCENTRATION are emitted by Concentration Calculator module per incoming tuple of type _SENSOR
       // application.addTupleMapping("clientModule1", "ACTION_COMMAND", "ACTUATION_SIGNAL", new FractionalSelectivity(1.0));
